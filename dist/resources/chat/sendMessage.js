...
async function execute(context, i, baseUrl, headers, headersJson) {
    const chatId = context.getNodeParameter("sendMessageChatId", i);
    const text = context.getNodeParameter("sendMessageText", i);
    const attendantId = context.getNodeParameter("sendMessageAttendantId", i);
    const sendFile = context.getNodeParameter("sendFile", i);
    if (sendFile) {
