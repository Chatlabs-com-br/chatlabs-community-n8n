    ...
    for (let i = 0; i < items.length; i++) {
      ...
      try {
        ...
        if (operation === "getDepartment") {
          const deptId = this.getNodeParameter("getDepartmentId", i) as string;
        ...
        if (operation === "listDepartments") {
          const perPage = this.getNodeParameter("deptPerPage", i) as number;
          const cursor = this.getNodeParameter("deptCursor", i) as string;
        ...
        if (operation === "getChatMessageFile") {
          const messageId = this.getNodeParameter("messageFileId", i) as string;
        ...
        if (operation === "listChatMessages") {
          const chatId = this.getNodeParameter("chatMessagesId", i) as string;
          const perPage = this.getNodeParameter("chatMessagesPerPage", i) as number;
          const cursor = this.getNodeParameter("chatMessagesCursor", i) as string;
        ...
        if (operation === "getChat") {
          const chatId = this.getNodeParameter("getChatId", i) as string;
        ...
        if (operation === "listChats") {
          const perPage = this.getNodeParameter("chatPerPage", i) as number;
          const qs: IDataObject = { perPage };
